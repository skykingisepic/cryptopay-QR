...
https://cryptopay.domain?receive_address@ast?inv/memo&ast?amount - this will populate all data fields from the URL delimited with '*' and all will be persistent. To reset, just use https://cryptopay.domain.
